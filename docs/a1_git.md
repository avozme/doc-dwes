...
* Los archivos de configuracion. Es habitual en una aplicación web tener un archivo de configuración (llamado config.php o algo parecido) con un puñado de variables donde se guarda el host de la base de datos, el usuario y la contraseña para ese host, el nombre de la base de datos, etc. Y, vamos a ver, ¿de verdad quieres que cualquiera que acceda a tu repositorio de GitHub o GitLab vea esa información?
...
Y, cuando tengas una o varias cosas preparadas en la Staging Area... Bueno, entonces llega el momento de hacer un **commit**.

### 8.3.2. Hacer commit

Un **commit** (que podríamos traducir por "perpetrar", ni más ni menos) consiste en empaquetar todos los cambios de la Staging Area para enviarlos a otro repositorio, normalmente el repositorio remoto.
...
### 8.3.4. Diagrama del flujo de trabajo habitual
